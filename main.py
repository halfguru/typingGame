...
class Game():
    ...
    def run(self):
        ...
        oldLevel = 1; highlightColor = self.WHITE; self.cooldown = 300; self.keypressCheck = False
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if keys[pygame.K_SPACE] and self.keypressCheck is False:
                    incrementSpeed = incrementSpeed + 3
                    self.keypressCheck = True

                elif self.keypressCheck is True:
                    incrementSpeed -= 3
            ...
            if Scoreboard.error == 20:
                ...
                level.run("gameover")
                newWord = True
                Scoreboard.speedLevel = 1
                Scoreboard.level = 1
                Scoreboard.error = 0
                Scoreboard.score = 0
                scoreboard.wordLength = 3
                Scoreboard.progress_percent = 0
                frame_count = 0
                self.word_counter = 0
                self.character_counter = 0
